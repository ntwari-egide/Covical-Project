...
/**
 * @description setting up options for selector of countries in the form
 */
...
/**
 * @description adding our new implementation of select control for showing up icons
 * @param props: these are props from selector
 */
...
/**
 * @description adding our new implementation of select options to show icons
 * @param props: these are props from selector
 */
...
/**
* @description resusable component ContinentDataComponent for handling data of every continent, it is passed in the slider
*/
